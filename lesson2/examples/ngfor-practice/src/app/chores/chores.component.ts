...
export class ChoresComponent implements OnInit {
   // chores = ['Empty dishwasher', 'Complete LaunchCode prep work', "Clean bathroom","laundry", "vacuuming", "sweeping", "mopping", "taking out the trash"];
   // todoTitles = ["Yesterday's Chores", "Today's Chores", "Tomorrow's Chores", "Forgot ToDo"];
   chores = [
